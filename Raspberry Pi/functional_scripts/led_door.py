...
# mqtt
topic = "iot/actuators/doorlight"
topic2 = "iot/pddl/doorlight"
host = "1.1.1.1"
...
try:
    ...
    def ledSwitch(isActive):
        ...
        if isActive == "True"and oldval == 0:
            ...
            client.publish(topic2, "(is-on doorled1)", 2)
        elif isActive == "False" and oldval == 1:
            oldval = 0
            GPIO.output(36, GPIO.LOW)
            client.publish(topic2, "(not(is-on doorled1))", 2)

    client = mqtt.Client('Door LED')
